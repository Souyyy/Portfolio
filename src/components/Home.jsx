...
const introduction = `Développeur web de formation et technicien informatique. J'assure l'installation, la maintenance et le support des systèmes informatiques, tout en mettant à profit mes compétences en développement web pour créer des outils adaptés aux besoins.`;
    let anneeExpertise = Math.floor((new Date() - new Date('2020-09-01')) / (1000 * 60 * 60 * 24 * 365));
    ...
    return (
                ...
                <div className="flex w-full flex-col items-center justify-center rounded-lg p-6 dark:bg-slate-900">
                    <div className="box grid  gap-3 grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-6">
                        ...
                        <div className=" shadow p-6 rounded-xl col-span-2 md:col-span-3 lg:col-span-5 flex flex-col sm:flex-row ring-1 ring-zinc-900 gap-3">
                            ...
                            <div className='sm:ml-6 sm:mt-2'>
                                ...
                                <div className='flex mt-3 gap-2 flex-wrap justify-center sm:justify-start'>
                                    ...
                                    <a href={lien_cv} target="_blank" className='hidden' rel="noopener noreferrer">
                                        <div className='hidden lt-box rounded-xl text-xs flex items-center justify px-3 py-1 ring-1 ring-zinc-800 transition hover:-rotate-3'>
                                            <p>Voir mon CV</p>
                        ...
                        <div className="flex justify-center  items-center flex-col shadow p-6 rounded-xl row-span-1 md:row-span-3 lg:row-span-2 ring-1 ring-zinc-900">
                            ...
                            <h4 className='text-center text-sm'>années d'expériences</h4>
                        </div>
		...
		C84.761,72.361,85.127,71.296,84.96,70.237z"/>
                        ...
                        <div className=" shadow p-6 rounded-xl col-span-2 md:row-span-2 lg:col-span-2 ring-1 ring-zinc-900 flex flex-col ">
                            <h3 className="font-semibold text-xl">Dernier diplôme obtenu</h3>
                            <div className='m-auto'>
                                <p className='text-md text-zinc-400 uppercase m-auto text-center my-4'>Licence profesionnelle projet web & mobile.</p>
                                <div className='flex m-auto gap-2 flex-wrap justify-center'>
                                    <div className='lt-box rounded-xl text-xs flex items-center justify px-2 py-1 ring-1 ring-zinc-800'>Sorbonne Université</div>
                                </div>
                                <p className='italic text-sm text-zinc-700 mt-4 text-center'>Septembre 2025.</p>
                            </div>
                        </div>
